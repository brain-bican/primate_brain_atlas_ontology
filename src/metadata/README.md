 ...
 * [pbao.yml](pbao.yml)
     * Determines how your purl.obolibrary.org/obo/pbao/ redirects will be handled
     ...
     * Paste in the contents of [pbao.yml](pbao.yml)
 ...
 * [pbao.md](pbao.md)
     ...
     * Paste in the contents of [pbao.md](pbao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
